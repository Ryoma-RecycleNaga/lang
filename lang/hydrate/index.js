...
styles.set('sc-app-home','/*!\@.app-home*/.app-home.sc-app-home{padding:10px}/*!\@button*/button.sc-app-home{background:#5851ff;color:#fff;margin:8px;border:none;font-size:13px;font-weight:700;text-transform:uppercase;padding:16px 20px;border-radius:2px;-webkit-box-shadow:0 8px 16px rgba(0,0,0,.1),0 3px 6px rgba(0,0,0,.08);box-shadow:0 8px 16px rgba(0,0,0,.1),0 3px 6px rgba(0,0,0,.08);outline:0;letter-spacing:.04em;-webkit-transition:all .15s ease;transition:all .15s ease;cursor:pointer}/*!\@button:hover*/button.sc-app-home:hover{-webkit-box-shadow:0 3px 6px rgba(0,0,0,.1),0 1px 3px rgba(0,0,0,.1);box-shadow:0 3px 6px rgba(0,0,0,.1),0 1px 3px rgba(0,0,0,.1);-webkit-transform:translateY(1px);transform:translateY(1px)}');
styles.set('sc-app-profile','/*!\@.app-profile*/.app-profile.sc-app-profile{padding:10px}');
styles.set('sc-app-root','/*!\@header*/header.sc-app-root{background:#5851ff;height:56px;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-webkit-box-shadow:0 2px 5px 0 rgba(0,0,0,.26);box-shadow:0 2px 5px 0 rgba(0,0,0,.26)}/*!\@h1,header*/h1.sc-app-root, header.sc-app-root{color:#fff}/*!\@h1*/h1.sc-app-root{font-size:1.4rem;font-weight:500;padding:0 12px}');
styles.set('sc-content-page','/*!\@:host*/.sc-content-page-h{display:block}');
styles.set('sc-stencil-route','stencil-route.inactive{display:none}');
styles.set('sc-pp-tools','/*!\@.pp-tools-container*/.pp-tools-container.sc-pp-tools{color:red}');
