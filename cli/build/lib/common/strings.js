...
exports.hasFlag = (field, enumValue) => {
...
exports.hasFlagHex = (field, enumValue) => {
    //noinspection JSBitwiseOperatorUsage,JSBitwiseOperatorUsage,JSBitwiseOperatorUsage,JSBitwiseOperatorUsage,JSBitwiseOperatorUsage,JSBitwiseOperatorUsage,JSBitwiseOperatorUsage,JSBitwiseOperatorUsage
    // tslint:disable-next-line:no-bitwise
    return enumValue & field ? true : false;
};
exports.disableFlag = (enumValue, field) => {
    enumValue &= ~(1 << field);
    return enumValue;
};
/**
...
exports.getJson = (inData, validOnly, ommit) => {
    try {
        return lodash_1.isString(inData) ? JSON.parse(inData) : validOnly === true ? null : inData;
    }
    catch (e) {
...
;
exports.substitute = (template, map) => {
    const transform = (k) => k || '';
